...
public class SearchModFragment extends Fragment implements ModItemAdapter.SearchResultCallback {
    ...
    /** Pass as a boolean fragment argument to force mod-only (not modpack) search. Defaults to modpack search. */
    ...
    public void onAttach(@NonNull Context context) {
        ...
        // No argument passed (existing modpack-install callers) -> keep the original modpack search behavior
        mSearchFilters.isModpack = args == null || args.getBoolean(ARG_IS_MODPACK, true);
    }
