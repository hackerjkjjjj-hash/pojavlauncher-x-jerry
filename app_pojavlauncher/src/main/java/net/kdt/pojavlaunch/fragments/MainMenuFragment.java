...
public class MainMenuFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // TODO: replace with your real Telegram admin link (e.g. "https://t.me/your_username")
        mNewsButton.setOnClickListener(v -> Tools.openURL(requireActivity(), "https://t.me/@jerrymc75"));
        mDiscordButton.setOnClickListener(v -> {
            Bundle args = new Bundle(1);
            args.putBoolean(SearchModFragment.ARG_IS_MODPACK, false); // search mods, not modpacks
